export class PromptRefiner {
    ...
    compareStrategies(prompt, strategyKeys) {
        if (!strategyKeys) {
        ...
        const bestKey = Object.keys(comparisons).reduce((a, b) => comparisons[a].suitability > comparisons[b].suitability ? a : b);
        return {
            prompt,
            comparisons,
    ...
    scoreStrategyFit(prompt, strategy) {
        const promptLower = prompt.toLowerCase();
